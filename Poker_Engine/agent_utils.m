...
function [agents_info] = return_agents(num_builtin_agents, agents_dir, exclude_dir)
    builtin_agents_MD = {'MakeDecision_Absolute', 'MakeDecision_Random', ...
        'MakeDecision_Default'};
    builtin_agents_SU = {'StageUpdater_Default', 'StageUpdater_Default', ...
        'StageUpdater_Default'};
    builtin_agents_UO = {'UpdateOpponent_Default', 'UpdateOpponent_Default', ...
        'UpdateOpponent_Default'};
    builtin_agents_strs = {'Absolute', 'Random', 'Default'};
